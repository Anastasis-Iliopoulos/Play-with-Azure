...
SUBSCRIPTION_ID = os.environ['comp_subscription_id']
RESOURCE_GROUP = os.environ['comp_resource_group']
STORAGE_ACCOUNT = os.environ['comp_storage_account']
LOCATION = os.environ['comp_location']
VNET_NAME = os.environ['comp_vnet_name']
SUBNET_NAME = os.environ['comp_subnet_name']
VM_NAME = os.environ['comp_vm_name']
NIC_NAME = os.environ['comp_nic_name']
IP_CONFIG_NAME = os.environ['comp_ip_config_name']
IPNAME = os.environ['comp_ip_name']
OS_PROFILE_ADMIN_USERNAME = os.environ['comp_os_profile_admin_username']
OS_PROFILE_ADMIN_PASSWORD = os.environ['comp_os_profile_admin_password']
NSG_NAME = os.environ['comp_nsg_name']
